        ...
        {pub && (
          <>
            <div>
              ...
              <h1 className="text-2xl font-semibold tracking-[-0.02em]">{pub.titre}</h1>
                  ...
                  <CardContent className="space-y-3">
                    {(pub.accuses?.length || 0) > 0 ? (
                      pub.accuses.map((a: any) => (
                        <div key={a.id} className="text-sm rounded-lg border border-white/10 bg-white/5 px-3 py-2">
                    ...
                    {pub.canReply && !pub.hasAr && (
                      <div className="space-y-2 pt-2 border-t border-border/60">
                        <textarea
                          className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm min-h-[70px]"
